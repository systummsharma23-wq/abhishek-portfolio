        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-14 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            <p className="text-base sm:text-xl text-white/70 font-body leading-relaxed max-w-xl">
              Currently accepting selected brand identity commissions, book projects, and cultural exhibition art direction. Let's discuss your next visual landmark.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 p-2.5 rounded-[28px] sm:rounded-full bg-[#181818] border border-white/15 shadow-2xl max-w-xl">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="w-full sm:w-auto px-5 py-2.5 rounded-full bg-white/10 hover:bg-white/20 text-white text-xs font-grotesk font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all active:scale-95"
                >
                  {copied ? (
                    <>
            ...
            <div className="pt-2">
              <button
                ...
                className="text-xs font-grotesk uppercase tracking-wider text-white/80 hover:text-[#F5A623] flex items-center gap-2 underline underline-offset-4"
              >
              ...
              >
                {formSubmitted ? (
                  ...
                  <>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {servicesList.map((service) => (
                          <button
                            ...
                            className={`px-3.5 py-1.5 rounded-full text-[11px] font-grotesk transition-all ${
                    ...
                    <button
                      type="submit"
                      className="w-full py-3.5 rounded-full bg-[#F5A623] hover:bg-white text-black font-grotesk font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-colors shadow-lg"
                    >
          ...
          {/* RIGHT: Social channels and network links */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3">
              {profile.socials.map((social) => (
                <a
                  ...
                  className="p-5 rounded-[24px] bg-white/[0.03] border border-white/10 hover:border-[#F5A623] hover:bg-white/[0.06] flex items-center justify-between group transition-all"
                >
                  <div>
                    <p className="font-display font-bold text-sm text-white group-hover:text-[#F5A623] transition-colors">
                      {social.name}
                    </p>
                  ...
                  <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-white/70 group-hover:bg-[#F5A623] group-hover:text-black transition-colors">
                    <ArrowUpRight className="w-3.5 h-3.5" />
                  </div>
                </a>
              ))}
